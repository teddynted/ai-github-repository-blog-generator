...
// ReleasePackage bundles every upstream artifact the X Thread Generator consumes.
// The generator never regenerates these — it composes technical threads from
// them. Context is required (the ground truth); SEO, Visual Assets, Architecture,
// and LinkedIn supply reusable metadata and references.
type ReleasePackage struct {
	Context      *rc.ReleaseContext                  // Milestone 2 — the ground truth
	Blog         releasegen.BlogPost                 // Milestone 3 — source of code snippets
	...
	SEO          seo.SEOMetadata                     // Milestone 10 — hashtags, keywords
	Architecture architecture.ArchitectureCollection // Milestone 11 — diagram references
	LinkedIn     linkedin.LinkedInCollection         // Milestone 12
}
