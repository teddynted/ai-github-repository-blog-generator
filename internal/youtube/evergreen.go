...
const evergreenRule = ` Keep the copy EVERGREEN: never say "this release", "the release", "this update", "this version", or "this feature", never state a version number, and never name the repository. Describe what the system DOES, not that a version shipped it (say "CloudWatch logs every exit inline", not "this release adds logging"), and never frame it as "by the numbers" or a commit/file/line count. Craft it like a top technical YouTube educator: hook on a concrete engineering pain point, make every line earn the next for high retention, and cut filler, hype, and clickbait.`
