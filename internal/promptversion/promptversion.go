...
var versions = map[string]int{
	...
	"storyboard-scenes":    6, // detect named AWS services/nodes in each scene and depict THEM specifically (images match content) // content-driven subject (depict named services as iconography) + recognizable-not-abstract style // SDXL quality suffix + structured prompt // deterministic per-scene SDXL image specs derived from the storyboard (bumped with storyboard@2: narration-alignment fields change)
}
