...
- **Sync:**
  ...
  - [Overlay] Land the on-screen text as you say it. (Amazon EventBridge)
...
- **Production notes:**
  ...
  - Load the 3 pronunciation entries into your TTS lexicon (or brief the narrator) before recording.
